...
// get all cart items
router.get('/get-all-cart-items', async (request, response) => {
    try {
...
router.get('/get-cart-items-of-a-user/:userId', async (request, response) => {
...
router.post('/create-cart-item-of-a-user/:userId', async (request, response) => {
    const { userId } = request.params;
...
// update cart item
router.post('/update-cart-item/:userId', async (request, response) => {
    const { userId } = request.params;
...
router.post('/delete-cart-item/:userId', async (request, response) => {
    const { userId } = request.params;
