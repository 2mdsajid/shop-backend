...
router.get('/get-products-by-category/:category', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var category, products, products_1, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                ...
                return [4 /*yield*/, ProductServices.getProductsByCategory(category)
                    // this is if there is no product in the database -- will return dummy products
                    // remove later after updating database
                ];
            case 1:
                products = _a.sent();
                if (!(products.length === 0)) return [3 /*break*/, 3];
                return [4 /*yield*/, ProductServices.getDummyProductsByCategory(category)];
            case 2:
                products_1 = _a.sent();
                return [2 /*return*/, response.status(200).json({ data: products_1 })];
            case 3: return [2 /*return*/, response.status(200).json({ data: products })];
            case 4:
                error_2 = _a.sent();
