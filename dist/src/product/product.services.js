...
var getDummyProductsByCategory = function (category) { return __awaiter(void 0, void 0, void 0, function () {
    var products, mappedProducts;
    return __generator(this, function (_a) {
        products = data_1.dummy_bag_data.filter(function (product) { return product.category === category; });
        mappedProducts = products.map(function (product) { return ({
            id: product.id,
            name: product.name,
        ...
        return [2 /*return*/, mappedProducts.length > 0 ? mappedProducts : null];
    });
}); };
exports.getDummyProductsByCategory = getDummyProductsByCategory;
...
var createProduct = function (productData) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                error_1 = _a.sent();
                console.log("🚀 ~ createProduct ~ error:", error_1);
                return [3 /*break*/, 6];
