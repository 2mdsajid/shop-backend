...
router.post('/create-category', async (request: Request, response: Response) => {
  try {
...
router.get("/get-all-products", async (request: Request, response: Response) => {
  try {
...
router.get("/get-product-by-id/:productId", async (request: Request, response: Response) => {
  try {
...
router.get('/get-product-base-by-id/:productId', async (request: Request, response: Response) => {
  try {
    const productId = request.params.productId;
...
router.get('/get-latest-products', async (request: Request, response: Response) => {
  try {
...
router.post("/create-new-product", async (request: Request, response: Response) => {
  try {
...
router.get('/delete-product-by-id/:productId', async (request: Request, response: Response) => {
  try {
    const productId = request.params.productId;
...
router.post("/update-product-by-id/:productId", async (request: Request, response: Response) => {
  try {
    const productId = request.params.productId;
...
router.post("/add-to-favourite/:productId", checkUserExists, async (request: RequestWithUser, response: Response) => {
  try {
    const productId = request.params.productId;
...
// // add to favourite
router.get("/get-favourite-products", checkUserExists, async (request: RequestWithUser, response: Response) => {
  try {
    const userId = request.user?.id;
    if (!userId) {
      return response.status(404).json({ data: null, message: 'User not found' });
...
router.get("/remove-from-favourite/:productId", checkUserExists, async (request: RequestWithUser, response: Response) => {
  try {
    const productId = request.params.productId;
    const userId = request.user?.id;
    if (!userId) {
