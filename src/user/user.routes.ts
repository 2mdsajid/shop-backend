...
router.get('/get-user-session', checkUserExists, async (request: RequestWithUser, response: Response) => {
  try {
...
router.post('/lucia-google-auth', async (request: Request, response: Response) => {
  try {
...
router.post('/generate-auth-token', async (request: Request, response: Response) => {
  try {
