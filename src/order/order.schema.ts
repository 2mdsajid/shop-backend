...
import { baseShippingAddressSchema } from "../shipping/shipping.schema";
// Order status enum
...
// Check type compatibility for Order
type orderSchemaCompatibilityWithPrisma = TOrderBase extends Order
    ? "Compatible"
    : "Mismatch";

// Check type compatibility for OrderItem
type orderItemSchemaCompatibilityWithPrisma = TOrderItemBase extends OrderItem
    ? "Compatible"
    : "Mismatch";

// Results for validation
type OrderCompatibilityResult = orderSchemaCompatibilityWithPrisma;
type OrderItemCompatibilityResult = orderItemSchemaCompatibilityWithPrisma;
